        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    {!!Form::open(['route'=>'store','method'=>'POST','role'=>'form','class'=>'form-horizontal','files' => true])!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9"><!--idform-field-select-3-->
                            <select name="Id_est" class="chosen-select form-control" id="estados" data-placeholder="Elije un Estado...">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9"><!--idform-field-select-3-->
                            ...
                            <select name="Id_mun" class="form-control selectpicker" id="municipios">
