                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>$45</td>
                                            <td class="hidden-480">3,330-{{ $val->banned }}</td>
                                            <td>Feb 12</td>
                                            ...
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    @if ($val->banned === 0)
                                                    {!!link_to_route('dashboard.status', $title = 'Activar', $parameters = [$val->id], $attributes = ['style'=>'color:white; text-decoration:none;','class'=>'btn btn-xs btn-info']);!!}
                                                    @else
